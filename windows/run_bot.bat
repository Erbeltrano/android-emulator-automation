...
rem vedi "[HOME] Attendo che il villaggio sia pronto..." in BOT_COMPLETO_MAC.py).
...
echo Avvio il bot...
"C:\Users\simon\AppData\Local\Programs\Python\Python312\python.exe" -u BOT_COMPLETO_MAC.py > bot_log.txt 2>&1
